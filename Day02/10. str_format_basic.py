...
print('수학 점수: {}점'.format(point)) # 요 방식을 쫌 더 많이사용함
print('{}월 {}일은 {}입니다.'.format(month,day,anni))
print('{1}월 {2}일은 {0}입니다.'.format(anni,month,day)) #뒤죽박죽 줘도 순서대로 번호로 지정해주면 잘 출력된다. 근데 많이 안쓰는 방법
...
# {}안에서 수식을 사용할 수 있습니다.
print(f'점수는 {point+10}점입니다.') # 사칙연산 사용 가능.
