'''
* 정수형 (Integer)
- 수치형 타입 중 정수형(int)은 양수, 음수의 정수값을 표현
소수점 이하 자리는 표현할 수 없습니다.

- 다른 언어는 저장 범위가 타입마다 정해져있지만,
...
print(bin(33))
print(oct(0b111001)) #2진수를 8진수로
print(hex(8923))


'''
* 실수형 (floatation point)
...
b1 = True
b2 = False
#b3 = false (x) 변수로 인식 (앞글자를 대문자로!)

#파이썬은 문자열도 동등 비동등 비교 가능합니다,
# 대/소문자까지 정확하게 일치해야 True를 도출합니다.
password = 'abc1234!'
