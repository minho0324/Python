...
# map(함수,리스트) -> 리스트 내부 요소를 함수로 전달. 리스트 자리에 튜플도 가능
# 여러 개의 데이터를 한번에 다른 형태로 변환하기 위해 사용.
# map(int, list) -> list 내부의 모든 데이터를 int()로 전달
